...
public class MainActivityFragment extends Fragment {
    ...
    private static final int ACCELERATION_THRESOLD = 100000;
    ...
    public void onPause() {
        super.onPause();
        disableAccelerometerListerner();
    }

    private void disableAccelerometerListerner() {
        SensorManager sensorManager =
                (SensorManager) getActivity().getSystemService(Context.SENSOR_SERVICE);
    ...
    private final SensorEventListener sensorEventListener = new SensorEventListener() {
        ...
        public void onSensorChanged(SensorEvent event) {
            if (!dialogOnScreen) {
                ...
                if (acceleration > ACCELERATION_THRESOLD)
                    confirmErase();
            }
        }
    ...
    private void confirmErase() {
        EraseImageDialogFrame fragment = new EraseImageDialogFrame();
